...
/***/ "./src/js/_parts/_delivery-special.js":
/*!********************************************!*\
  !*** ./src/js/_parts/_delivery-special.js ***!
  \********************************************/
/*! no static exports found */
...
$(document).ready(function () {
  ...
  window.customColor = function () {
    ...
    $('.delivery-special .products__item__price__normal').css({
      'color': deliveryColor
    });
<<<<<<< HEAD:build___/js/main.js
...
=======
    ...
    //});
>>>>>>> 13a542b7239fb9957f61f0004f32c58351b60c64:build/js/main.js
...
$(window).scroll(function () {
  ...
  if (scroll >= headerTopHeight) {
    ...
    mainWrap.css('padding-top', headerTopHeight + headerDeliveryHeight + 60 + 'px');
  } else {
  ...
  if ($(window).width() < 992) {
    if (scroll >= headerTopHeight) {
      headerTop.addClass('fixed').css('top', '0');
      headerDelivery.addClass('fixed').css({
        'top': headerTopHeight,
        'transition': 'none'
      });
      mainWrap.css('padding-top', headerTopHeight + headerDeliveryHeight + 80 + 'px');
    } else {
      headerTop.removeClass('fixed').css('top', '0');
      headerDelivery.removeClass('fixed').css('top', '0');
      mainWrap.css('padding-top', '0');
    }
  } else {
...
$(document).ready(function () {
  if ($('#city-choose').length) {//cityChoose();
    //console.log("всплывашка городов есть");
  } else {//console.log("всплывашки городов нет");
    }
});
...
window.makeTimer = function () {
  ...
  }, 1000); //console.log("После выставления нормальных чисел");
};
...
/* harmony import */ var _parts_delivery_special__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./_parts/_delivery-special */ "./src/js/_parts/_delivery-special.js");
/* harmony import */ var _parts_delivery_special__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(_parts_delivery_special__WEBPACK_IMPORTED_MODULE_23__);
